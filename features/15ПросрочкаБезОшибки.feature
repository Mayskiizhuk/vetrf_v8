...
//Ссылка на задачу: https://redmine.kb99.pro/issues/6777
...
Сценарий: Просрочка по реализации №00000000001 от 31.01.2023
	...
	*Загрузка партии с просроченной продукцией
		И я перехожу к закладке с именем 'СтраницаОтладка'
    	И в поле с именем 'ПартииНач' я ввожу текст "23.01.2026"
    	И в поле с именем 'ПартииКон' я ввожу текст "23.01.2026"
	...
	*Выбор просроченной партии и проверка сообщений
		...
		И в таблице 'Список' в дополнение формы с именем 'СписокСтрокаПоиска' я ввожу текст "932"
		...
		И в таблице 'Товары' в поле с именем 'ТоварыКоличество' я ввожу текст "0,200000"
